...
export default function PatientNavbar({ activeTab, setActiveTab, setActiveModal }) {
    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/90 shadow-xs w-full">
      <div className="w-full px-4 lg:px-8 xl:px-12 flex items-center justify-between gap-4 h-[72px] overflow-hidden">
        ...
        <div className="flex items-center gap-2.5 shrink-0 whitespace-nowrap">
          ...
          <a 
            className="h-9 px-3 flex items-center gap-1.5 bg-rose-50 border border-rose-200 text-rose-700 text-[11px] font-extrabold rounded-xl hover:bg-rose-100 transition-all shadow-xs" 
            href="tel:108"
          >
